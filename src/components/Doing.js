...
const Doing = () => {
  ...
  const updateDoing = (harsh) => {
    ref.current.click();
    console.log(harsh)
   setDoing({id: harsh._id, title: harsh.title, description: harsh.description});
  };
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button
                type="button"
                onClick={handleClick}
                disabled={InitialDoing.title.length < 5 || InitialDoing.description.length < 5}
